...
print("Lendo arquivo ...")
# filepath = sys.argv[1]
filepath = "/home/thiago/Documentos/codigos/trabalho-Final-BioInfo/Atividade_9.COMPUTACAO.PROVA.Vale 10.composicao_1_Bioinformaticas_size_30000_k_50.txt"
f = open(filepath, "r")
arquivo = f.readlines()
f.close()
...
with open("ThiagoSilva.txt", 'w') as arquivo:    
