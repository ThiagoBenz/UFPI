...
public class TesteControleEstoqueResumido {
	...
	@Test
	public void testarAtualizacaoPrecoDeCompra() throws ProdutoJaCadastrado, DadosInvalidos, ProdutoInexistente, ProdutoNaoPerecivel{
	  Fornecedor f1 = new Fornecedor(1, "Forn1");
	  Produto p1 = new Produto(1, "coca-cola", 5, 0.5, f1);
	...
	@Test
	public void testarCompraProdutosPereciveis() throws ProdutoJaCadastrado, DadosInvalidos, ProdutoInexistente, ProdutoNaoPerecivel{
	  Fornecedor f1 = new Fornecedor(1, "Forn1");
	  Produto p1 = new Produto(1, "coca-cola", 5, 0.5, f1);
	...
	@Test
	public void testarEstoqueMinimo() throws ProdutoJaCadastrado, DadosInvalidos, ProdutoInexistente, ProdutoNaoPerecivel{
	  Fornecedor f1 = new Fornecedor(1, "Forn1");
